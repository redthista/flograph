"""Persist node output caches alongside a .flopy project file.

A side-car directory named "<project>.flopy.cache/" holds one pickle blob
...
SCHEMA_VERSION: the .flopy JSON itself is untouched, only a sibling
directory is added.
