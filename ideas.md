...
2. Export py script option, that creates a output script mirroring the flow. nice to use when a flopy workflow has matured enough to move the script to its own python script thats stands alone outside of the tool.
